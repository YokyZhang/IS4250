...
```{r, echo=FALSE}
library(ggplot2)
labs <- read.csv("~/NUS/Year4_Sem2/IS4250/Tutorial/2/labs.csv")
...
labsTC <- read.csv("~/NUS/Year4_Sem2/IS4250/Tutorial/2/labsTC.csv")
...
summary(m4)
cat("BMI = 6.609016 + 0.023387*AGE + 0.058949*SBP + 0.039896*TC + 0.086733*GdrN")
cat("Let AGE=45, SBP=135, TC=150, GdrN=1, we get BMI=21.690679")
